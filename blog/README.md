...
to GitHub Pages from the **Chibuzo-Ukegbu** GitHub account.
...
1. Sign in to GitHub as **Chibuzo-Ukegbu**.
2. Click the **+** icon (top right) → **New repository**.
3. Repository name: **`Chibuzo-Ukegbu.github.io`** (must match the username exactly).
...
8. Go to **Settings → Pages**. Source = "Deploy from a branch", Branch = `main`,
   Folder = `/ (root)`. Save.
9. After ~1 minute, the site is live at **https://chibuzo-ukegbu.github.io/**.
...
git branch -M main
git remote add origin https://github.com/Chibuzo-Ukegbu/Chibuzo-Ukegbu.github.io.git
...
If you change your username from `Chibuzo-Ukegbu`:
